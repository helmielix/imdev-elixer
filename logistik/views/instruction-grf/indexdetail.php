...
<div class="instruction-wh-transfer-detail-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            // [
            //     'attribute'=>'id_Instruction_grf',
            //     'value'=>'id_Instruction_grf',
            // ],
            [
                'label' => 'Status',
                'format' => 'raw',
            ...
            [
                ...
                'buttons'=>[
                    ...
                    //             return "";
                    //         }else{
                    //             if(GrfDetail::find()->where(['and',['id_instruction_grf'=>$model->id_instruction],['orafin_code'=>$model->orafin_code]])->exists()){
                    //                 return Html::a('<span style="margin:0px 2px;" class="label label-success">Choose</span>', '#update', [
                    //                     'title' => Yii::t('app', 'create'), 'class' => 'updatesButton','idInstructionGrf'=>$model->id_instruction,'orafinCode'=>$model->orafin_code, 'rrNumber'=>$model->rr_number, 'header'=> yii::t('app','Create Material GRF Vendor IKO')
                    //                 ]);
                    //             }else{
