...
use common\models\searchReference;
...
class ReferenceController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
			$modelcek = Reference::find()->andWhere(['table_relation' => $model->table_relation])->count();
			$model->id_grouping = $modelcek + 1;
			if(!$model->save()) {            
                Yii::$app->session->setFlash('error',Displayerror::pesan($model->getErrors()));
