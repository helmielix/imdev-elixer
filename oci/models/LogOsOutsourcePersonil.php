 ...
 */
class LogOsOutsourcePersonil extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'log_os_outsource_personil';
    }
    ...
    {
        // return $this->hasOne(OspTeamWoActual::className(), ['nik' => 'employee_number']);
    ...
    {
        return $this->hasOne(IkoTeamWoActual::className(), ['nik' => 'employee_number']);
    ...
    {
        return $this->hasOne(Reference::className(), ['id' => 'id_vendor']);
    }
    /**
     * @return \yii\db\ActiveQuery
     */
