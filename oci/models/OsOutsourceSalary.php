...
/**
 * This is the model class for table "os_outsource_salary".
 *
 * @property integer $id
 ...
 */
class OsOutsourceSalary extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
           // [[ 'id_division', 'id_city', 'month'], 'required'],
			...
			[[ 'total_invoice', 'total', 'total_gaji'], 'double'],
    ...
    public function getIdOsOutsourceFormSalary()
    {
        return $this->hasOne(OsOutsourceFormSalary::className(), ['id' => 'id_os_outsource_form_salary']);
    }
