...
/**
 * This is the model class for table "log_ca_itp_monthly".
 *
 ...
 * @property integer $itp_year
 * @property integer $itp_month
 */
class LogCaItpMonthly extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
