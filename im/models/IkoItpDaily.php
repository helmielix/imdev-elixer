...
class IkoItpDaily extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['no', 'itp_date', 'holes_digging_target', 'poles_planting_target', 'poles_foundry_target', 'cable_rollout_target', 'cable_arr_target', 'pvc_instalation_target', 'pole_painting_target', 'fatfdt_splicing_target', 'created_by', 'created_date', 'status_listing', 'id_iko_itp_area', 'odc_splicing_target'], 'required'],
            [['itp_date', 'created_date', 'updated_date'], 'safe'],
            [['holes_digging_target', 'poles_planting_target', 'poles_foundry_target', 'cable_rollout_target', 'cable_arr_target', 'pvc_instalation_target', 'pole_painting_target', 'fatfdt_splicing_target', 'id_iko_itp_area', 'odc_splicing_target'], 'integer'],
