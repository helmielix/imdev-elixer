...
if(Yii::$app->controller->action->id == 'index_presurvey') $this->title = Yii::t('app','Input Presurvey');
if(Yii::$app->controller->action->id == 'indexverify_presurvey') $this->title = Yii::t('app','Verify Presurvey');
if(Yii::$app->controller->action->id == 'indexapprove_presurvey') $this->title = Yii::t('app','Approve Presurvey');
...
<div id="southPanel" > 
	...
	<?php function getFilterStatus() {
		...
		if(Yii::$app->controller->action->id == 'indexverify_presurvey') 
			return [
				1 => 'Inputted',
				2 => 'Revised',
				4 => 'Verified',
			];
		if(Yii::$app->controller->action->id == 'indexapprove_presurvey') 
			return [
				5 => 'Approved',
				4 => 'Verified'
			];
				...
				[
					...
					'buttons' => [
						...
						'draw' => function ($url, $model) {
							if(Yii::$app->controller->action->id == 'index_presurvey' && $model->status_presurvey != 6) {
