	...
	$columns = []; 
	    ...
	    array_push($columns,
				...
				'value' => function ($searchModel) {
						return "<span class='label' style='background-color:{$searchModel->statusReference->status_color}' >{$searchModel->statusReference->displayText()}</span>";
	    ...
	    array_push($columns, ['attribute' => 'no_iom_area_exp']);
		array_push($columns, 
		    [ 
