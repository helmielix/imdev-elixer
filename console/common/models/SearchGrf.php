...
class SearchGrf extends Grf
{
    ...
    {
        return [
            [['id', 'grf_type', 'requestor', 'created_by', 'updated_by', 'status_listing', 'pic', 'id_region', 'id_division', 'status_return'], 'integer'],
            [['grf_number', 'wo_number', 'file_attachment_1', 'file_attachment_2','file_attachment_3','purpose', 'created_date', 'updated_date','grf_type_des'], 'safe'],
        ];
    }
