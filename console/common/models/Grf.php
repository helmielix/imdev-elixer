...
class Grf extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [[ 'grf_type','requestor','created_by', 'updated_by', 'status_listing', 'pic', 'id_region', 'id_division', 'status_return', 'id_vendor'], 'integer'],
            [['purpose'], 'string'],
            [['created_date', 'updated_date','grf_type_des','date_of_return'], 'safe'],
