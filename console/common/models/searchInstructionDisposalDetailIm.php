...
use common\models\InstructionDisposalDetailIm;

/**
 * searchInstructionDisposalDetailIm represents the model behind the search form about `common\models\InstructionDisposalDetailIm`.
 */
class searchInstructionDisposalDetailIm extends InstructionDisposalDetailIm
{
    /**
     * @inheritdoc
     */
