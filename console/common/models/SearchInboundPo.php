...
class SearchInboundPo extends InboundPo
{
    ...
    public function rules()
    {
        return [
            ...
            [['created_date', 'updated_date','pr_number','po_number','supplier','tgl_sj','rr_number', 'item_name','im_code','brand','warna','grouping','qty','qty_good','qty_not_good','qty_reject','orafin_name','orafin_code','sn_type','id_inbound'], 'safe'],
        ];
    }
