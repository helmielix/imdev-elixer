 ...
 */
class InboundGrf extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    public $grf_type, $grf_number, $wo_number, $file_attachment_1, $file_attachment_2, $purpose, $id_region, $id_division, $requestor, $pic,$division, $file1, $file2, $orafin_code, $qty_request, $wh_origin, $id_instruction_grf;
    ...
    {
        return $this->hasOne(InboundGrfDetail::className(), ['id_inbound_grf' => 'id']);
    }

    public function getIdOutboundGrf()
    {
        return $this->hasOne(OutboundGrf::className(), ['id_instruction_grf' => 'id']);
    }
