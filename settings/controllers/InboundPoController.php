  ...
  //           'dataProvider' => $dataProvider,
    ...
    public function actionQtycond($id = NULL, $idInboundPo = NULL){
    	...
    	if ($model->load(Yii::$app->request->post())) {	
    		// return print_r($_POST['InboundPoDetail']['qty_good']);
    		$qtyGood = $_POST['InboundPoDetail']['qty_good'];
    		$qtyNotGood = $_POST['InboundPoDetail']['qty_not_good'];
    		$qtyReject = $_POST['InboundPoDetail']['qty_reject'];
