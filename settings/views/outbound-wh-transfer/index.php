                ...
                'buttons'=>[
                    'view' => function ($url, $model) {
                         if(Yii::$app->controller->action->id == 'index' && !isset($model->status_listing)){
                            return Html::a('<span style="margin:0px 2px" class="glyphicon glyphicon-plus"></span>', '#viewinstruction?id='.$model->id_instruction_wh.'&header=Detail_Material_GRF_Vendor_IKO', [
                                'title' => Yii::t('app', 'view'), 'class' => 'viewButton', 'value'=>Url::to([$this->context->id.'/viewinstruction','id' => $model->id_instruction_wh]), 'header'=> yii::t('app','Detail Material GRF Vendor IKO')
                            ]);
                        } 
						else {
                            if(Yii::$app->controller->action->id == 'index') {
                            ...
                            if(Yii::$app->controller->action->id == 'indexprintsj') {
	                            ...
	                            return Html::a('<span style="margin:0px 2px" class="glyphicon glyphicon-plus"></span>', '#'.$viewurl.'?id='.$model->id_instruction_wh.
								'&header='.$headerlnk, [
