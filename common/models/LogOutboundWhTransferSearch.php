...
use divisitiga\models\LogOutboundWhTransfer;

/**
 * LogOutboundWhTransferSearch represents the model behind the search form of `divisitiga\models\LogOutboundWhTransfer`.
 */
class LogOutboundWhTransferSearch extends LogOutboundWhTransfer
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = LogOutboundWhTransfer::find();
