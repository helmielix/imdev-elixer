...
use divisitiga\models\InstructionRepair;

/**
 * InstructionRepairSearch represents the model behind the search form of `divisitiga\models\InstructionRepair`.
 */
class InstructionRepairSearch extends InstructionRepair
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'updated_by', 'created_by', 'id_warehouse', 'status_listing', 'id_modul', 'qty', 'vendor_repair'], 'integer'],
