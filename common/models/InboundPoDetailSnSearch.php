...
use divisitiga\models\InboundPoDetailSn;

/**
 * InboundPoDetailSnSearch represents the model behind the search form of `divisitiga\models\InboundPoDetailSn`.
 */
class InboundPoDetailSnSearch extends InboundPoDetailSn
{
    /**
     * {@inheritdoc}
     */
