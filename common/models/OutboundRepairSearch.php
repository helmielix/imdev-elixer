...
use divisitiga\models\OutboundRepair;

/**
 * OutboundRepairSearch represents the model behind the search form of `divisitiga\models\OutboundRepair`.
 */
class OutboundRepairSearch extends OutboundRepair
{
    /**
     * {@inheritdoc}
     */
