 ...
 */
class OutboundRepair extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
	public $instruction_number, $target_pengiriman, $wh_destination, $wh_origin, $grf_number;
    public static function tableName()
    {
        return 'outbound_repair';
    }
     ...
     */
    public function getIdInstructionRepair()
    {
