...
/**
 * SearchInboundGrfDetail represents the model behind the search form about `common\models\InboundGrfDetail`.
 */
class SearchInboundGrfDetail extends InboundGrfDetail
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'id_inbound_grf', 'qty_good', 'qty_noot_good', 'qty_reject', 'qty_dismantle_good', 'qty_dismantle_ng', 'qty_good_rec'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->joinWith('idInboundGrf.idGrf.idGrfDetail.idOrafinCode');
        
        
        $query->andWhere(['id_inbound_grf' => $id]);
