...
use divisitiga\models\LogOutboundGrf;

/**
 * LogOutboundGrfSearch represents the model behind the search form of `divisitiga\models\LogOutboundGrf`.
 */
class LogOutboundGrfSearch extends LogOutboundGrf
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['idlog', 'id', 'created_by', 'updated_by', 'status_listing', 'grf_type', 'id_division', 'id_region', 'pic', 'forwarder', 'id_modul'], 'integer'],
