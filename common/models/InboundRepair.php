 ...
 */
class InboundRepair extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
	public $instruction_number, $target_pengiriman, $vendor, $wh_destination, $wh_origin, $name;
    ...
    {
        return [
            'id_instruction_repair' => 'Id Instruction Wh',
            'driver' => 'Driver',
    ...
    public function getTaggingList()
    {
        return $this->hasOne(InboundRepairTagging::className(), ['id_tagging' => 'tagging']);
    }
}
