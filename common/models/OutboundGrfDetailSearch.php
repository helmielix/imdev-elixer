...
use divisitiga\models\OutboundGrfDetail;

/**
 * OutboundGrfDetailSearch represents the model behind the search form of `divisitiga\models\OutboundGrfDetail`.
 */
class OutboundGrfDetailSearch extends OutboundGrfDetail
{
    /**
     * {@inheritdoc}
     */
