...
class InstructionGrfDetail extends \yii\db\ActiveRecord
{
    ...
    public function beforeDelete()
    {
        ...
        // $this->normalizestok($this->id_item_im);
        $modelIm = MasterItemImDetail::find()
                ->andWhere(['id_master_item_im' => $this->id_item_im])
                ->andWhere(['id_warehouse' => $this->idInstructionGrf->id_warehouse])
                ->one();

        // check every Request column for changed
        // if(isset($this->oldAttributes['qty_good'])){
        if( $this->qty_good > 0 ){
            // The attribute is changed. Do something here...
            // data mau dihapus, kembalikan nilai ke stok awal
        ...
        // if(isset($this->oldAttributes['qty_not_good'])){
        if( $this->qty_not_good > 0 ){
            // The attribute is changed. Do something here...
            // $modelIm = MasterItemImDetail::findOne($this->id_item_im);
        ...
        // if(isset($this->oldAttributes['qty_reject'])){
        ...
        // if(isset($this->oldAttributes['qty_dismantle'])){
        if( $this->qty_dismantle > 0 ){
            // The attribute is changed. Do something here...
            // $modelIm = MasterItemImDetail::findOne($this->id_item_im);
        ...
        // if(isset($this->oldAttributes['qty_revocation'])){
        if( $this->qty_revocation > 0 ){
            // The attribute is changed. Do something here...
            // $modelIm = MasterItemImDetail::findOne($this->id_item_im);
        ...
        // if(isset($this->oldAttributes['qty_good_rec'])){
        if( $this->qty_good_rec > 0 ){
            // The attribute is changed. Do something here...
            // $modelIm = MasterItemImDetail::findOne($this->id_item_im);
        ...
        // if(isset($this->oldAttributes['qty_good_for_recond'])){
        if( $this->qty_good_for_recond > 0 ){
            // The attribute is changed. Do something here...
            // $modelIm = MasterItemImDetail::findOne($this->id_item_im);
    ...
    private function normalizestok($iditemim)
    {
        $modelIm = MasterItemImDetail::find()
                ->andWhere(['id_master_item_im' => $iditemim])
                ->one();
