...
/**
 * SearchOutboundWhTransfer represents the model behind the search form about `common\models\OutboundWhTransfer`.
 */
class SearchOutboundWhTransfer extends OutboundWhTransfer
{
