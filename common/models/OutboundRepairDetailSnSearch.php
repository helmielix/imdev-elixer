...
use divisitiga\models\OutboundRepairDetailSn;

/**
 * OutboundRepairDetailSnSearch represents the model behind the search form of `divisitiga\models\OutboundRepairDetailSn`.
 */
class OutboundRepairDetailSnSearch extends OutboundRepairDetailSn
{
    /**
     * {@inheritdoc}
     */
