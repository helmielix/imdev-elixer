...
<div class="instruction-wh-transfer-view">    
            ...
            <?= DetailView::widget([
                ...
                'attributes' => [
                    ...
                    [
                        ...
                        'value'=>$model->idGrf->idDivision->nama,
    ...
    <p> 
        ...
        <?php if((Yii::$app->controller->action->id == 'viewapprove' && $model->status_listing != 5) || 
                (Yii::$app->controller->action->id == 'viewinbound' && $model->status_listing == 5))
        ...
        <?php if((Yii::$app->controller->action->id == 'viewinbound' && $model->status_listing == 5))
