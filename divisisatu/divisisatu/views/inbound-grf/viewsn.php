                    ...
                    'create' => function ($url, $model) {
                        if(($model->status_listing == 999 || $model->status_listing == 43) && $model->sn_type ==1){
                            ...
                            return Html::a('<span style="margin:0px 2px;" class="label label-success">Upload SN</span>', '#', [
                                ...
                                'title' => Yii::t('app', 'create'), 'data-pjax' => false,'class' => 'qtycondButton', 'value'=> $model->id_inbound_detail,'idInboundPo' => $model->id_inbound_po, 'qty' => $model->qty, 'header'=> yii::t('app','Create Material GRF Vendor IKO')
                            ]);
					...
					'view' => function ($url, $model) {
                         if(($model->status_listing == 41 || $model->status_listing == 43) && $model->sn_type ==1){
                            ...
                            return Html::a('<span style="margin:0px 2px;" class="label label-info">View</span>', '#', [
                                'title' => Yii::t('app', 'create'), 'data-pjax' => false,'class' => 'viewButton', 'value'=>$model->id_inbound_detail, 'header'=> yii::t('app','Create Material GRF Vendor IKO')
                            ]);
                        }else if(($model->status_listing == 41 || $model->status_listing == 43) && $model->sn_type ==2){
                            return Html::a('<span style="margin:0px 2px;" class="label label-info">View</span>', '#', [
                                'title' => Yii::t('app', 'create'),'data-pjax' => false, 'class' => 'viewQtycondButton', 'value'=> $model->id_inbound_detail,'idInboundPo' => $model->id_inbound_po, 'qty' => $model->qty, 'header'=> yii::t('app','Create Material GRF Vendor IKO')
                            ]);
                        }
                    },
