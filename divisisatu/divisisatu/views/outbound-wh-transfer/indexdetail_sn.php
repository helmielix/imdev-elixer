		...
		if(Yii::$app->controller->action->id != 'viewapprove'){
			...
			<?php 
				if($idbutton == 'exportButton'){
					echo Html::button(Yii::t('app',$actionName), ['id'=>'printButton','class' => 'btn btn-success','value'=>Url::to(['outbound-wh-transfer/exportsj', 'id' => $model->id_instruction_wh])]) ;	
				}else{
...
<script>
    ...
    $('#printButton').click(function(){
    	var pagetoprint = window.open("<?php echo Url::to([$this->context->id.'/exportsj', 'id' => $model->id_instruction_wh]) ?>", "_blank");
