...
//print_r($reqItemNotGood);
                        ...
                        $out .= '</div>';
                        $out = Html::textInput('rnotgood[]', @$reqItemNotGood[$model->id], ['class' => 'form-control input-sm txt-notgood', 'data-notgood' => $model->s_not_good, 'data-current' => @$reqItemNotGood[$model->id]]);
                        return $out;
                    },
                    'contentOptions' => ['class' => 'bg-danger'],
                    'headerOptions' => ['class' => 'kartik-sheet-style'],
...
//print_r($reqItem);exit();
                        $out = '<div class="col-xs-12">';
                        $out .= '</div>';
                        $out = Html::textInput('rreject[]', @$reqItem[$model->id], ['class' => 'form-control input-sm txt-reject', 'data-current' => @$reqItem[$model->id], 'data-reject' => $model->s_reject]);
                        return $out;
                    },
                    'contentOptions' => ['class' => 'bg-danger'],
                    'headerOptions' => ['class' => 'kartik-sheet-style'],
...
//    $('#')
    ...
    $('#submitButton').click(function () {
        ...
        $.ajax({
            url: '<?php echo Url::to([$this->context->id . '/updatedetail', 'idDetail' => $idDetail]); ?>',
            type: 'post',
            data: data,
            processData: false,
            contentType: false,
