...
<div class="instruction-wh-transfer-detail-index">
    ...
    <p>
        <?= Html::button(Yii::t('app', 'Download Template'), ['id' => 'downloadButton', 'class' => 'btn btn-primary']) ?>
    </p>
    <?php
    Pjax::begin([
        'id' => 'pjaxindexdetail',
                ...
                'buttons' => [
                    ...
                    'update' => function ($url, $model) {
                        return Html::a('<span style="margin:0px 2px" class="glyphicon glyphicon-pencil"></span>', '#', [
                                    'title' => Yii::t('app', 'update'), 'class' => 'viewButton', 'value' => Url::to([$this->context->id . '/updatedetail', 'idDetail' => $model->id]), 'header' => yii::t('app', 'Update Detail Repaires Instruction')
                        ]);
                    },
                ],
            ],
...
?>');
        $('#modalHeader').html('<h3> Create Create Repair Instruction</h3>');
    });
