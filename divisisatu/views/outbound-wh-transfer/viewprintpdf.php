...
<div class="container" id="main">
        ...
        <div class="row row-eq-height">
            <div class="col-xs-6 borderTop  borderLeft borderBottom">
                ...
                <dl class="row pad10top">
                  <dt class="col-xs-4">No. GRF</dt>
                  <dd class='col-xs-8'><?= $model->idInstructionWh->grf_number ?></dd>
                  <dt class="col-xs-4">Tgl. Diterbitkan</dt>
                  <dd class='col-xs-8'><?= $model->published_date ?></dd>
                  <dt class="col-xs-4">Gudang Asal / Alamat</dt>
                  <dd class='col-xs-8'><?= $model->idInstructionWh->whOrigin->nama_warehouse ?></dd>
                  <dt class="col-xs-4">Tujuan / Alamat</dt>
                  <dd class='col-xs-8'><?= $model->idInstructionWh->whDestination->nama_warehouse ?></dd>
                  <dt class="col-xs-4">Tim</dt>
                  <dd class='col-xs-8'><?= $email ?></dd>
                  <dt class="col-xs-4">Dept. / Vendor Cont. / Forwarder</dt>
                  <dd class='col-xs-8'><?= $model->forwarder0->description ?></dd>
                ...
                <table class="table table-striped table-bordered table-condensed" style='page-break-after:auto'>
                    <thead style='display:table-header-group'>
                        <tr class="info" style='page-break-inside:avoid; page-break-after:auto'>
                            ...
                            <th colspan="4">QTY Per Kondisi</th>
                    ...
                    <tbody style='display:table-header-group'>
                        ...
                        for ($i=0; $i < count($modelDetail); $i++) {
                            ...
                            <td style='page-break-inside:avoid; page-break-after:auto'>{$modelDetail[$i]['id_item_im']}</td>
                            <td style='page-break-inside:avoid; page-break-after:auto'>{$modelDetail[$i]['id_item_im']}</td>
    ...
    <div class="row borderRight borderLeft borderBottom" id="rowthree" style='page-break-inside:avoid; page-break-after:auto'>
        <div class="row">
            <div class="col-xs-offset-6 col-xs-3 text-center"><?= $vendor ?></div>
            <div class="col-xs-3 text-center">PT. MNC Kabel Mediacom</div>
        </div>

        <div class="row pad80top pad20bottom">
            <div class="col-xs-offset-6 col-xs-3 text-center">( ---------------------- )</div>
