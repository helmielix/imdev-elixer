...
use usermanagement\models\SearchSubdistrict;
...
class SubdistrictController extends Controller
{
    ...
    {
        $searchModel = new SearchSubdistrict();
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
		     $value = Yii::$app->mailer->compose()
	                ...
	                -> setSubject ( 'Alert Verify Subdistrict' )
	                -> setHtmlBody( 'This document is waiting your approval. Please click this link document :'.Yii::getAlias('@web').'/subdistrict/indeverify')
	                -> send();
    ...
    // Function untuk find Subdistrict berdasarkan id
	...
	// Action Mengambil List District berdasarkan dedrop City
