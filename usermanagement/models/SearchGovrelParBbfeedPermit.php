...
/**
 * GovrelparbbfeedpermitSearch represents the model behind the search form about `app\models\GovrelParBbfeedPermit`.
 */
class SearchGovrelParBbfeedPermit extends GovrelParBbfeedPermit
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = GovrelParBbfeedPermit::find();
