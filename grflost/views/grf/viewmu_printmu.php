        ...
        <div>
            <?= DetailView::widget([
                ...
                'attributes' => [
                    // 'id_instruction_grf',
                    [
                        'label' => 'Material Usage Number',
                        'attribute' => function($model){
                            if($model->idInstructionGrf->idGrf) return $model->idInstructionGrf->idGrf->mu_number;
                        }
                    ],
                    [
                        'label' => ' Nomor GRF',
                    ...
                    [
                        ...
                        'value' => function($model){
                            if($model->idInstructionGrf->idGrf->idRegion) return $model->idInstructionGrf->idGrf->idRegion->name;
                        }
                    ],
                    [
                        'label' => 'Team Leader',
                        'value' => function($model){
                            if($model->idInstructionGrf->idGrf) return $model->idInstructionGrf->idGrf->team_leader;
                        }
                    ],
                    [
                        'label' => 'Department/Vendor Contractor',
                        'value' => function($model){
                            if($model->idInstructionGrf->idGrf->idDivision) return $model->idInstructionGrf->idGrf->idDivision->nama;
                        }
                    ],
                    // [
                    //     'attribute' => 'grf_type',
