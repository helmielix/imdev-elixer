...
<div class="outbound-grf-view">
            ...
            <?= DetailView::widget([
                ...
                'attributes' => [
                    ...
                    [
                        ...
                        'value'=> $model->idInboundGrf->idGrf->idDivision->nama,
                        // 'visible' => is_string($model->no_sj),
                    ],
                    'pic',
                    [
                        'label' => 'Tanggal Pengembalian',
                        'attribute' => 'date_of_return',
                    ],
                ],
            ]) ?>
        </div>
  ...
  <div class="alert hidden" id="errorSummary">Please fix these following error: <ul id="ulerrorSummary"></ul></div>
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($model){
                    ...
                    return $out = Html::hiddenInput('id[]', $model->id, ['class' => 'id']);
            ...
            [
                ...
                'value' => 'statusReturn.status_listing',
             ...
             [
                ...
                'value' => function ($model){
                    ...
                    return $out = Html::hiddenInput('status_return[]', $model->status_return, ['class' => 'status_return']);
    ...
    <p>
        <?php if(Yii::$app->controller->action->id == 'createmr')
...
<script>
    ...
    $('#inputButton').click(function () {
        ...
        $.ajax({
            url: '<?php echo Url::to([$this->context->id.'/updatedetail', 'id' => $model->id]) ;?>',
            type: 'post',
            data: data,
            processData: false,
            contentType: false,
